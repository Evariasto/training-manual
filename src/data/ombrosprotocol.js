          ...
          categories: [
            {
              ...
              exercises: [
                ...
                },
                {
                  ...
                  musclesFocus: 'Deltóide Anterior + Deltóide Lateral + Tríceps',
                  execution: [
                    'Ajuste o banco em ~80° de inclinação dentro do Smith',
                    'Barra começa na altura do queixo — pegada pronada, mãos ligeiramente mais largas que ombros',
                    'Empurre verticalmente até quase extensão total dos cotovelos',
                    'Desça com controle até a linha do queixo/clavícula — não abaixo do pescoço',
                    'Mantenha o core contraído — não arqueie a lombar para ganhar impulso',
                  ],
                  tip: 'A guia do Smith permite usar cargas maiores com segurança e focar 100% na contração dos deltóides. Excelente para treinar sem parceiro. Varie o ponto de parada: mais alto = mais tríceps, mais baixo = mais deltóide anterior.',
                },
                {
                  ...
                  musclesFocus: 'Deltóide Anterior + Lateral + Tríceps',
                  execution: [
                    'Halteres na altura das orelhas, cotovelos a ~90° e levemente à frente',
                    'Empurre para cima convergindo os halteres sem bater no topo',
                    'Desça até cotovelos alinhados com ombros — amplitude máxima',
                    'Mantenha pulsos neutros — não deixe dobrar para trás',
                  ],
                  tip: 'Maior amplitude de movimento que com barra — ativa mais deltóide lateral e permite rotação natural do ombro. Ideal para volume e conexão mente-músculo.',
                },
              ],
            },
            {
